...
2. 在`Linux`系统中，如`/floppy`是一块`MS-DOS`文件系统的软盘的挂载点，`/tmp/test`是`Ext2`文件系统的一个目录，我们执行`cp /floppy/TEST /tmp/test`, 进行目录的拷贝，相当于执行下面这段代码：
...
<div align="center">
   <img src="fs1.png" alt="文件系统初始化调用关系图">
</div>
...
<div align="center">
   <img src="fs2.png" alt="文件系统初始化调用关系图">
</div>