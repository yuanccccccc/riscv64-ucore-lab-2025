...
uintptr_t sysfile_mmap(uintptr_t addr, size_t len, int prot, int flags, int fd, off_t offset); // memory map
int sysfile_munmap(uintptr_t addr, size_t len);                                                // unmap memory
